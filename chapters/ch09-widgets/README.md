# Глава 9. Всё вокруг — виджет

Проект `widget_playground` — песочница глав 9–13, создаётся в начале этой главы.
...
В книге код главы набирается прямо в `main.dart`. В готовой песочнице каждый опыт — отдельный экран в `lib/screens`, а `main.dart` (см. главу 13) — меню всех опытов. Чтобы запустить один экран, подставьте его в `home:` вместо Scaffold.
