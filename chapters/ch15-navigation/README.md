# Глава 15. Много экранов: навигация
...
- `lib/screens/playground_screen.dart` — стартовое меню всех опытов глав 10–16.
...
Экраны глав 10–12, на которые тоже ссылается `main.dart`, лежат здесь же — папка запускается как есть (картинки и шрифты для главы 14 — в папке `ch14-theme`).
